...
def classify_grade(number_grade:float):
    '''Item 2.
...
def average_weight(item_quantity_1:int, item_weight_1:float, item_quantity_2:int, item_weight_2:float):
    '''Item 3.
    ...
    '''
    # Write your code below this line
    qw1 = (item_quantity_1*item_weight_1)
    qw2 = (item_quantity_2*item_weight_2)
    wa1 = (qw1+qw2)/(item_quantity_1+item_quantity_2)
    return(wa1)

def string_sum(string:str):
    '''Item 4.
    String Sum. 3 points.
